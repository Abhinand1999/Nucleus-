            ...
            <div className='grid md:grid-cols-3 gap-10'>
                <div className="pb-[50px] px-[30px] rounded-md">
                    ...
                    <figure className="w-[100px] h=[100px] rounded-full border-2 border-solid border-primaryColor">
                        <img src={userData.image} alt="" className="w-full h-full rounded-full" />
                    </figure>
                </div>
                ...
                <div className="md:col-span-2 md:px-[30px]">
                    <div>
                        ...
                        <button onClick={()=>setTab('settings')} className={` ${tab=="settings" && "bg-primaryColor text-white font-normal"} p-2 mr-5 px-5 rounded-md text-headingColor font semibold text-[16px] leading-7 border border-solid border-primaryColor`}>Profile Settings</button>
                    </div>
                    {
